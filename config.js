...
module.exports = {
    ...
    PLK: process.env.OWNER_NAME === undefined ? 'Alexa' : process.env.OWNER_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'ꪶ͢Alexa࿐' : process.env.BOT_NAME,
    ...
    SUDO: process.env.SUDO === undefined ? '12028071779,0' : process.env.SUDO,
    DEBUG: DEBUG,
